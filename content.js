...
const CONTENT = {
  ...
  ui: {
    ...
    en: {
      ...
      alreadyVotedSub: 'Results will be announced during the afternoon session',
  ...
  thankyou: {
    ...
    en: {
      ...
      giftDesc: 'Show this screen at the counter to collect your gift! 🎁',
      timeLabel: 'Vote Time',
      idLabel: 'Vote ID',
      eventInfo: [
